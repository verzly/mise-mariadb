...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/verzly/mise-mariadb"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "AGPL-3.0"
--- Plugin description
PLUGIN.description = "MariaDB version manager plugin for mise (by verzly)"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/verzly/mise-mariadb/releases/download/manifest/manifest.json"
-- Some things that need user to be attention!
PLUGIN.notes = {
    "For macOS and Linux user:",
    "mariadb installation requires some dependencies.",
    "For more detailed, please refer to https://github.com/verzly/mise-mariadb/blob/main/README.md"
}
